...
JINA_API_KEY = "jina_539b2918d3a8494aa3c59787fbbc5dc9M2I9XBfl7onL3aQsj3apQClL1SPa"
EMBED_MODEL = "jina-embeddings-v2-base-en"  # or "jina-embeddings-v2-base-en"
...
def main():
    ...
    query = args.question
    answer_qdrant = retrieve_qdrant(args, query)
    # ai_response = chain.invoke(query)
    # print(ai_response)


def retrieve_qdrant(args, query):
