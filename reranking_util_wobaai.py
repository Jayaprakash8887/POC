...
def retrieve_and_rerank(query):
    ...
    initial_results = retriever.similarity_search_with_score(query, k=20)
    ...
    for score in marqo_scores:
        # print("doc:: ", documents[i], " || marqo_score:: ", (marqo_weight * score), " || bm25_score:: ", (bm25_weight * 0.01 * bm25_scores[i]), " || bert_score:: ", (bert_weight * bert_scores[i]), " || TOTAL:: ", (marqo_weight * score + bm25_weight * 0.01 * bm25_scores[i] + bert_weight * bert_scores[i]))
        combined_scores.append(marqo_weight * score + bm25_weight * 0.01 * bm25_scores[i] + bert_weight * bert_scores[i])
        i += 1
